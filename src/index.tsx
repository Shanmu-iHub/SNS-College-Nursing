...
import { BScNursingPage } from './pages/academics'
...
app.get('/academics/bsc-nursing', (c) => {
    return c.html(Layout(BScNursingPage(), 'B.Sc. Nursing', 'academics-bsc-nursing'))
})

app.get('/academics/curriculum', (c) => c.redirect('/academics/bsc-nursing', 301))

app.get('/academics/clinical-connect', (c) => c.redirect('/academics/bsc-nursing', 301))

// Redirect old school routes to new nursing pages
app.get('/academics/pre-primary', (c) => c.redirect('/academics/bsc-nursing', 301))
app.get('/academics/primary', (c) => c.redirect('/academics/curriculum', 301))
app.get('/academics/middle', (c) => c.redirect('/academics/clinical-connect', 301))
app.get('/academics/secondary', (c) => c.redirect('/academics/bsc-nursing', 301))
app.get('/academics/senior-secondary', (c) => c.redirect('/academics/bsc-nursing', 301))
