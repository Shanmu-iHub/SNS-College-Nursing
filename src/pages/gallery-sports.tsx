        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-12 text-center shadow-xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                    <a href="https://main.snsgroups.com/brochure/" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold text-lg transition inline-flex items-center justify-center">
                ...
                <p class="text-sm text-gray-600">
                    Admission Helpline: <a href="tel:+9190036 55855" class="text-blue-600 hover:underline font-bold">+91 90036 55855</a>
                </p>
            </div>
        </div>
    </section>
