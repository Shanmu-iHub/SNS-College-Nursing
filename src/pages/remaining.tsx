...
export const InnovationPage = () => {
    ...
    ${PageHeader(
        'SNS Innovation Hub',
        'Implementing Design Thinking in Healthcare | India\'s First Institute for Nursing Innovation',
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-12">
                <div>
                    <h2 class="text-4xl font-bold mb-6">About SNS iHub for Nursing</h2>
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        SNS iHub is an initiative by SNS Institutions to foster healthcare startups by providing a prototyping space immersed in an ambience of creativity and our <strong class="text-orange-600">patented Design Thinking framework</strong> specifically for the nursing field.
                    </p>
                    <p class="text-lg text-gray-700 leading-relaxed">
                        The center helps nursing students identify patient care needs and solve them using our AI-enhanced design thinking approach, mentored by experts from both medical and technology industries.
                    </p>
                </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg card-hover">
                    <div class="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-microscope text-3xl text-cyan-600"></i>
                    </div>
                    <h3 class="font-bold text-lg text-center mb-3">Medical Research</h3>
                    <p class="text-sm text-gray-600 text-center">Clinical studies, nursing ethics, patient safety</p>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                    ...
                    <!-- Microsoft -->
                    <div class="bg-white rounded-xl p-6 text-center card-hover shadow-lg border border-gray-100">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/9/96/Microsoft_logo_%282012%29.svg" class="w-16 h-16 mx-auto mb-4 object-contain" alt="Microsoft">
...
export const AboutPage = () => {
    return `
    ${PageHeader(
        'About SNS College of Nursing',
        'Imparting Professional Ethics and Skill-Based Clinical Excellence',
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="relative">
                    ...
                    <img src="/static/images/clinical_hero.png" alt="Students Learning" class="relative rounded-2xl shadow-2xl w-full object-cover h-[500px]">
                    <div class="absolute bottom-8 right-8 bg-white/90 backdrop-blur p-6 rounded-xl shadow-lg max-w-xs">
                        <p class="text-orange-600 font-bold text-lg mb-1">Our Philosophy</p>
                        <p class="text-gray-800 text-sm font-medium">Imparting Professional Ethics and Skill-Based Clinical Excellence</p>
                    </div>
                </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            <div class="w-12 h-12 bg-orange-50 rounded-lg flex items-center justify-center flex-shrink-0 mr-4">
                                <i class="fas fa-stethoscope text-xl text-orange-600"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg">Clinical Excellence</h4>
                                <p class="text-gray-600 text-sm">Hands-on training at super-specialty hospitals.</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-900 text-lg">Design Thinking Hub</h4>
                                <p class="text-gray-600 text-sm">Innovating patient care solutions through empathy.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
export const ContactPage = () => {
    ...
    ${PageHeader(
        ...
        '/static/images/clinical_hero.png',
        'Contact Us'
    )}
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">SNS College of Nursing,<br>SNS Kalvi Nagar, Sathy Main Road (NH-209),<br>Saravanampatti Post,<br>Coimbatore - 641 035, Tamil Nadu.</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">Admission: +91 90036 55855 / +91 90036 55855<br>Counselling Code: 879</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">General: snsnursing@snsgroups.com<br>Support: webadmin@snsgroups.com</p>
                            </div>
                        </div>
                        <div class="flex items-start">
...
export const AdmissionsPage = () => {
    ...
    ${PageHeader(
        'Admissions 2026-27',
        'Imparting Clinical Excellence through Nursing Education',
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold mb-2">Enquiry & Registration</h3>
                        <p class="text-gray-700">Submit your enquiry through our website or visit the campus to register for the B.Sc. Nursing program.</p>
                    </div>
                </div>
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold mb-2">Eligibility Verification</h3>
                        <p class="text-gray-700">Our admissions team will verify your 10+2 marks (PCB aggregate) based on the Tamil Nadu Dr. M.G.R. Medical University norms.</p>
                    </div>
                </div>
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold mb-2">Counseling & Interview</h3>
                        <p class="text-gray-700">Shortlisted candidates will be called for a personal interview and counseling session to discuss career goals.</p>
                    </div>
                </div>
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold mb-2">Final Admission</h3>
                        <p class="text-gray-700">Upon successful completion of the interview and verification, final seats are allocated based on merit and university regulations.</p>
                    </div>
                </div>
            </div>
        </div>
