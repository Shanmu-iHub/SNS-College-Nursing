...
export const Layout = (content: string, title: string, activePage: string = 'home') => {
    ...
    <body class="antialiased bg-gray-50">
        ...
        <footer class="bg-gray-900 text-gray-300 py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            ...
                            <li><a href="https://main.snsgroups.com/brochure/" target="_blank" class="hover:text-white transition">Download Brochure</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm mb-4">
                            ...
                            <li><a href="tel:+9190036 55855" class="hover:text-white transition"><i class="fas fa-phone mr-2"></i>Admission: +91 90036 55855</a></li>
                            <li><a href="tel:+917550316708" class="hover:text-white transition"><i class="fas fa-phone mr-2"></i>Helpdesk: +91 90036 55855</a></li>
                ...
                <div class="border-t border-gray-800 pt-8 text-center text-sm">
                    ...
                    <p class="mt-3 text-orange-400 font-bold"><i class="fas fa-headset mr-2"></i>Admission Enquiry: 90036 55855 / 879</p>
                </div>
            </div>
        </footer>
        ...
        <a href="https://wa.me/9190036 55855" class="whatsapp-float" target="_blank" rel="noopener noreferrer"
