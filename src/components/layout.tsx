...
export const Layout = (content: string, title: string, activePage: string = 'home') => {
    ...
    <head>
        ...
        <title>${title} | SNS College of Nursing - First Design Thinking Nursing College in India</title>
        <meta name="description" content="SNS College of Nursing - India's first Design Thinking Nursing college in Coimbatore. Offering B.Sc. Nursing with world-class clinical training and infrastructure.">
        ...
        <link rel="icon" type="image/png" href="/static/SNS Nursing.png">
        ...
        <style>
            * { font-family: 'Inter', sans-serif; }
            ...
            .gradient-bg {
                background: linear-gradient(-45deg, #E5097F, #f03a9f, #f56bb7, #f996cd);
            ...
            .gradient-text {
                background: linear-gradient(135deg, #E5097F 0%, #b00761 50%, #f03a9f 100%);
            ...
            .hero-gradient-warm {
                background: linear-gradient(135deg, #fff2f8 0%, #fee4f1 25%, #fcbde1 50%, #f996cd 75%, #f56bb7 100%);
            }
            ...
            /* Badge/Tag Styles */
            .badge-glow {
                box-shadow: 0 0 20px rgba(229, 9, 127, 0.5);
                animation: glow 2s ease-in-out infinite;
            }
            
            @keyframes glow {
                0%, 100% { box-shadow: 0 0 20px rgba(229, 9, 127, 0.5); }
                50% { box-shadow: 0 0 30px rgba(229, 9, 127, 0.8); }
            }
    ...
    <body class="antialiased bg-gray-50">
        ...
        <!-- Hanging Tag 1: CBSE (now M.G.R...) -->
        <div class="fixed top-[15%] right-0 z-50 swing">
            <div class="bg-gradient-to-br from-green-600 to-emerald-600 text-white px-3 py-5 rounded-l-xl shadow-2xl">
                <span class="font-bold text-[10px] uppercase tracking-wider" style="writing-mode: vertical-rl; text-orientation: mixed;">M.G.R University Affiliated</span>
            </div>
        </div>
        
        <!-- Hanging Tag 2: Brochure -->
        <div class="fixed bottom-[15%] right-0 z-50 swing" style="animation-delay: 0.3s;">
            <a href="https://snsacademy.org/brochure/" target="_blank" class="bg-gradient-to-br from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white px-3 py-6 rounded-l-xl shadow-2xl flex flex-col items-center space-y-2 group transition-all">
                <i class="fas fa-file-pdf text-xl group-hover:scale-110 transition-transform duration-300"></i>
                <span class="font-bold text-[10px] uppercase tracking-wider" style="writing-mode: vertical-rl; text-orientation: mixed;">BROCHURE</span>
            </a>
        </div>
        ...
        <nav class="bg-white shadow-md sticky top-0 z-40">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    <a href="/" class="flex items-center space-x-3">
                        <img src="https://snsct.snscourseware.org/images/ctimg/snscn_logo.png" alt="SNS College of Nursing Logo" class="h-16 w-auto">
                    </a>
                    ...
                    <div class="hidden md:flex items-center space-x-6">
                        ...
                        <div class="relative group">
                            <button class="${activePage.startsWith('academics') ? 'text-orange-600 font-bold' : 'text-gray-700 hover:text-orange-600'} font-medium flex items-center">
                            ...
                            <div class="absolute hidden group-hover:block bg-white shadow-xl rounded-lg py-2 w-64 mt-0 z-50">
                                <a href="/academics/bsc-nursing" class="block px-4 py-2 hover:bg-orange-50 text-gray-700 font-semibold">B.Sc. Nursing (4 Years)</a>
                            </div>
                        </div>
            ...
            <div id="mobile-menu" class="hidden md:hidden bg-white border-t">
                <div class="px-4 py-4 space-y-3">
                    ...
                    <!-- Programs -->
                    <div>
                        <button class="w-full text-left text-gray-700 hover:text-orange-600 font-medium py-2 flex justify-between items-center" onclick="document.getElementById('mobile-programs').classList.toggle('hidden')">
                            Programs <i class="fas fa-chevron-down"></i>
                        </button>
                        <div id="mobile-programs" class="hidden pl-4 space-y-2 mt-2">
                            <a href="/academics/bsc-nursing" class="block text-gray-600 hover:text-orange-600 py-1">B.Sc. Nursing (4 Years)</a>
                        </div>
                    </div>
        ...
        <footer class="bg-gray-900 text-gray-300 py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid md:grid-cols-4 gap-8 mb-8">
                    <div>
                        <div class="flex items-center space-x-3 mb-4">
                            <img src="https://snsct.snscourseware.org/images/ctimg/snscn_logo.png" alt="SNS College of Nursing Logo" class="h-12 w-auto bg-white rounded p-1">
                        </div>
                        <p class="text-sm leading-relaxed">
                            Affiliated to The Tamil Nadu Dr. M.G.R. Medical University<br>
                            Recognized by INC & TNNMC<br>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="/academics/bsc-nursing" class="hover:text-white transition">B.Sc. Nursing</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm mb-4">
                            <li><i class="fas fa-map-marker-alt mr-2"></i>SNS College of Nursing,<br />SNS Kalvi Nagar, Sathy Main Road (NH-209),<br />Saravanampatti Post, Coimbatore - 641 035.</li>
                            <li><a href="tel:+917550316701" class="hover:text-white transition"><i class="fas fa-phone mr-2"></i>Admission: +91 75503 16701</a></li>
                            <li><a href="tel:+917550316708" class="hover:text-white transition"><i class="fas fa-phone mr-2"></i>Helpdesk: +91 75503 16708</a></li>
                            <li><a href="mailto:snsnursing@snsgroups.com" class="hover:text-white transition"><i class="fas fa-envelope mr-2"></i>snsnursing@snsgroups.com</a></li>
                        </ul>
                ...
                <div class="border-t border-gray-800 pt-8 text-center text-sm">
                    <p>&copy; 2026 SNS College of Nursing. All rights reserved.</p>
                    ...
                    <p class="mt-3 text-orange-400 font-bold"><i class="fas fa-headset mr-2"></i>Admission Enquiry: 75503 16701 / 879</p>
                </div>
            </div>
        </footer>
